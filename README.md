...
## 데이터 모델 설명 :chart_with_upwards_trend:


  ### 데이터 모델 1 : 직업별 지역 분포 :globe_with_meridians:
...
***
  ...
  ### 데이터 모델 3 : 유저별 경험치 집계 :hourglass_flowing_sand:
...
***
 ...
 ### 데이터 모델 4 : 자유전직 조회 테이블 :mag_right:
모험가 직업군의 자유전직 횟수를 조사하기 위한 테이블 입니다.

조회성능 향상을 위해 모험가 직업군으로만 구성되어 있습니다.

- **for SQL**

|character_name|character_level|class            |date      |key_value              |
|:-------------|:----------------|:---------------------|:-------|:----------------|
|버터          |297            |나이트로드       |2024-09-16|버터-2024-09-16        |
|곤주          |295            |아크메이지(불,독)|2024-09-16|곤주-2024-09-16        |
|검성OGC       |295            |히어로           |2024-09-16|검성OGC-2024-09-16     |
|중뒹          |295            |비숍             |2024-09-16|중뒹-2024-09-16        |
|꼴깍          |294            |듀얼블레이더     |2024-09-16|꼴깍-2024-09-16        |
|행쇼          |294            |비숍             |2024-09-16|행쇼-2024-09-16        |
|법행          |294            |아크메이지(불,독)|2024-09-16|법행-2024-09-16        |
|시들어가는날  |294            |히어로           |2024-09-16|시들어가는날-2024-09-16|
|갠갈          |294            |듀얼블레이더     |2024-09-16|갠갈-2024-09-16        |
|꾸장          |293            |나이트로드       |2024-09-16|꾸장-2024-09-16        |

***

 ### 데이터 모델 5 : 레벨 도달 유저 수 :dart:
